# 第一章、Spring与SpringBoot

## 1.1 Spring能做什么

### 1. Spring的能力

<img src="img\1.png" alt="image-20220925170751896" style="zoom: 50%;" />
...
<img src="img\2.png" alt="image-20220925171128788" style="zoom: 50%;" />
...
![image-20220925171834602](img\3.png)
...
![image-20220925171938575](img\4.png)
...
<img src="img\5.png" alt="image-20220925172054090" style="zoom:50%;" />

### 4. 如何学习SpringBoot

#### 1. 官网文档架构

<img src="img\6.png" alt="image-20220925172152981" style="zoom: 67%;" />

查看版本新特性；

https://github.com/spring-projects/spring-boot/wiki#release-notes

<img src="img\7.png" alt="image-20220925172256538" style="zoom: 67%;" />
...
- 默认的包结构
  ...
  - 无需以前的包扫描配置
  - 想要改变扫描路径，@SpringBootApplication(scanBasePackages=**"com.futurebytedance"**)
...
@ComponentScan("com.futurebytedance.boot")
```
...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        //4、com.futurebytedance.boot.config.MyConfig$$EnhancerBySpringCGLIB$$51f1e1ca@1654a892
...
@Bean ：类似于SpringMVC中配置的xml组件

@Component ：标记为一个Spring组件
...
<img src="img\8.png" alt="image-20220925173908434" style="zoom:50%;" />
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="haha" class="com.futurebytedance.boot.bean.User">
        <property name="name" value="zhangsan"></property>
        <property name="age" value="18"></property>
    </bean>

    <bean id="hehe" class="com.futurebytedance.boot.bean.Pet">
...
- EnableAutoConfiguration
  ...
  ![image-20220925174715489](img\9.png)
...
<img src="img\10.png" alt="image-20220925175315515" style="zoom: 67%;" />

- 自动依赖引入

<img src="img\11.png" alt="image-20220925175417710" style="zoom:50%;" />

- 自动创建项目结构

<img src="img\12.png" alt="image-20220925175450440" style="zoom: 50%;" />

- 自动编写好主配置类

<img src="img\13.png" alt="image-20220925175526588" style="zoom:50%;" />
...
<img src="img\14.png" alt="image-20221022210612346" style="zoom: 67%;" />
...
protected Object[] getMethodArgumentValues(NativeWebRequest request, @Nullable ModelAndViewContainer mavContainer,bject... providedArgs) throws Exception {
...
<img src="img\28.png" alt="img" style="zoom:67%;" />
...
<img src="img\29.png" alt="image.png" style="zoom:67%;" />

给前端自动返回json数据；

##### 1. 返回值解析器

<img src="img\30.png" alt="image.png" style="zoom:67%;" />
...
<img src="img\45.png" alt="img" style="zoom:67%;" />
...
<h2>
    <a href="www.futurebytedance.com" th:href="${link}">去百度</a>  <br/>
    <a href="www.futurebytedance.com" th:href="@{link}">去百度2</a>
</h2>
</body>
</html>
```
...
<img src="img\52.png" alt="image.png" style="zoom:67%;" />
...
<img src="img\55.png" alt="image.png" style="zoom:67%;" />
...
- - - **public class** **DefaultErrorAttributes** **implements** **ErrorAttributes**, **HandlerExceptionResolver**
  ...
  - <img src="img\59.png" alt="image.png" style="zoom:67%;" />

  - <img src="img\60.png" alt="image.png" style="zoom:67%;" />
...
![image.png](futurebytedanceimg\62.png)

- **2、系统默认的  异常解析器**

![image.png](futurebytedanceimg\63.png)
...
- - - **1、如果没有任何人能处理最终底层就会发送 /error 请求。会被底层的BasicErrorController处理**
  ...
  - ![image.png](futurebytedanceimg\64.png)
...
```java
@ServletComponentScan(basePackages = "com.futurebytedance.admin") :指定原生Servlet组件都放在那里
...
<img src="futurebytedanceimg\65.png" alt="image.png" style="zoom:67%;" />
...
![image.png](futurebytedanceimg\66.png)
...
![image.png](futurebytedanceimg\67.png)
...
spring:
  datasource:
    ...
    druid:
      aop-patterns: com.futurebytedance.admin.*  #监控SpringBean
...
<mapper namespace="com.futurebytedance.admin.mapper.AccountMapper">
<!--    public Account getAcct(Long id); -->
    <select id="getAcct" resultType="com.futurebytedance.admin.bean.Account">
...
- **@MapperScan("com.futurebytedance.admin.mapper") 简化，其他的接口就可以不用标注@Mapper注解**

### 4. 整合MyBatisPlus完成CRUD

#### 1. 什么是MyBatisPlus

[MyBatis-Plus](https://github.com/baomidou/mybatis-plus)（简称 MP）是一个 [MyBatis](http://www.mybatis.org/mybatis-3/) 的增强工具，在 MyBatis 的基础上只做增强不做改变，为简化开发、提高效率而生。[mybatis plus 官网](https://baomidou.com/) 建议安装 **MybatisX** 插件 
...
- **@Mapper 标注的接口也会被自动扫描；建议直接** @MapperScan(**"com.futurebytedance.admin.mapper"**) 批量扫描就行
...
![image.png](futurebytedanceimg\68.png)
...
![image.png](futurebytedanceimg\70.png)
...
![image.png](futurebytedanceimg\71.png)

### 2. 1.x与2.x不同

![image.png](futurebytedanceimg\72.png)
...
![image.png](futurebytedanceimg\73.png)
...
<img src="futurebytedanceimg\75.png" alt="img" style="zoom:67%;" />
...
**futurebytedance-hello-spring-boot-starter（启动器）**

**futurebytedance-hello-spring-boot-starter-autoconfigure（自动配置包）**
...
![image.png](futurebytedanceimg\76.png)

![image.png](futurebytedanceimg\77.png)

![image.png](futurebytedanceimg\78.png)
